...
2. Click **"Edit Roster & Bench"** to open the roster editor.

> **💡 PRO TIP:** While the app is fully touch-compatible for tablets like the iPad, **using a physical keyboard (like an iPad Magic Keyboard or a Bluetooth keyboard) for entering and editing team rosters is recommended, but not strictly necessary.** It will make pregame data entry significantly faster.

`[Insert Screenshot: The Roster Editor Modal]`

* **Adding Players:** Enter the player's number and name. Use the checkboxes to designate if they are a Goalkeeper (GK), Starter, or Captain.
...
1. Tap the button and enter the game clock time.
